...
int main() {
    ...
    Printer::PrintShedules(data, std::cout);
    Printer::PrintOperations(data, std::cout);
    Printer::PrintWorks(data, std::cout);
    /*std::ifstream input("../../test_data/test.txt");
    ProblemData data(input);
    Printer::PrintShedules(data, std::cout);
    Solver::Solve(data);
    Printer::PrintGants(data, std::cout);
    Printer::PrintOperations(data, std::cout);
    Printer::PrintAnswerJSON(data, std::cout);*/
    return 0;
}